...
describe("Render", function(){
    ...
    it ("render with stored test value", function(){
        assert.equal(renderer.render('<div data-sly-test.val="${properties.isTrue}"><p>Hello World</p></div>', data), '<div><p>Hello World</p></div>');
        data.should.have.property("val");
    })
});